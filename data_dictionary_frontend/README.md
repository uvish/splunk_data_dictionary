# Contributing to SplunkDatadictionaryFrontend
...
SplunkDatadictionaryFrontend uses [prettier](https://github.com/prettier/prettier) to ensure consistent code formatting. It is recommended
